...
_react2['default'].render(_react2['default'].createElement(_componentsPokeTable2['default'], { pokemons: pokemons }), app);
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        this.props.pokemons.map(function (pokemon) {
          return _react2['default'].createElement(_PokeRow2['default'], _extends({ key: pokemon.number }, pokemon));
        })
      );
    }
  }]);
